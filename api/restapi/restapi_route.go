...
func RegisterRoutes(authFacade auth.Facade, userFacade user.Facade, uuidUtil uuid.Util) http.Handler {
	router := mux.NewRouter().StrictSlash(true)
	handler := NewRouteHandler(authFacade, userFacade, uuidUtil)
